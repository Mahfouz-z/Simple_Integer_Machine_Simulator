...
all: $(BUILD_DIR)memory.o $(BUILD_DIR)SIM_Simulator_Driver.o $(BUILD_DIR)main.o $(BUILD_DIR)write_inst.o $(BUILD_DIR)le_inst.o $(BUILD_DIR)add_inst.o $(BUILD_DIR)ass_inst.o $(BUILD_DIR)read_inst.o $(BUILD_DIR)jmp0_inst.o $(BUILD_DIR)jmp_inst.o $(BUILD_DIR)mul_inst.o $(BUILD_DIR)neg_inst.o $(BUILD_DIR)helper_functions.o
	$(CXX) -O0 -std=c++11 -ggdb -fno-elide-constructors -o $(BIN_DIR)main $(BUILD_DIR)main.o $(BUILD_DIR)memory.o $(BUILD_DIR)SIM_Simulator_Driver.o $(BUILD_DIR)write_inst.o $(BUILD_DIR)le_inst.o $(BUILD_DIR)add_inst.o $(BUILD_DIR)ass_inst.o $(BUILD_DIR)read_inst.o $(BUILD_DIR)jmp0_inst.o $(BUILD_DIR)jmp_inst.o $(BUILD_DIR)mul_inst.o $(BUILD_DIR)neg_inst.o $(BUILD_DIR)helper_functions.o
